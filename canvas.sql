...
CREATE TABLE `grupos_de_entrega` (
  `id` int(11) NOT NULL,
  `grupo_entrega` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `objetivos_smart` (
  ...
  `mensuravel` varchar(255) DEFAULT NULL,
  `atingivel` varchar(255) DEFAULT NULL,
  `relevante` varchar(255) DEFAULT NULL,
